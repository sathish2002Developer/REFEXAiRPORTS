...
export function useTravelersCms() {
  ...
  return { airportId, setAirportId, draft, currentAirport, saving, saved, loading, error, handleSave, setField, updateBrand, addBrand, removeBrand, updateTerminal, addTerminal, removeTerminal, updateFaq, addFaq, removeFaq };
}
