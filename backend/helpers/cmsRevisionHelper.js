...
const RESOURCE_CONFIG = {
  ...
  home: { model: CmsHomePage, singletonKey: "home", payloadField: "payload" },
  about: { model: CmsAboutPage, singletonKey: "about", payloadField: "payload" },
...
async function archiveCurrentRevision(resourceType, req, label) {
  ...
  let row;
  try {
    row = await getSingletonRow(resourceType);
  } catch {
    return null;
  }
